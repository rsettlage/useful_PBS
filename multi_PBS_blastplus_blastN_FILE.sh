...
##`tblastx -outfmt '6 qseqid sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore qlen slen' -num_threads 6 -evalue 1e-6 -db $database_FILE -query $query_FILE -out $result_FILE`
...
`blastn -outfmt '6 qseqid sseqid pident qlen slen length mismatch gapopen qstart qend sstart send evalue bitscore' -num_threads 12 -evalue 1e-4 -db $database_FILE -query $query_FILE -out $result_FILE`

##alternate layout for the contigMerge program
##`blastn -outfmt '6 qseqid sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore qlen slen' -num_threads 12 -evalue 1e-4 -db $database_FILE -query $query_FILE -out $result_FILE`

## for xml output
##`blastn -outfmt 5 -num_threads 4 -evalue 1e-4 -max_target_seqs 5 -db $database_FILE -query $query_FILE -out $result_FILE`
