...
###print PBS script
PBS_script="/groups/DAC/useful_PBS/PBS_FASTQ_QC_control_EA_UTILS_miRNA.sh"
echo '#############################################################################'
more $PBS_script
echo '#############################################################################'
###########################################################################
...
adaptor_EXT="_AT"
summary_EXT=".sum.txt"
ADAPTER_FILE="/groups/DAC/vector_contaminant_fasta/IlluminaStandardAndMiRNA_Adpaters.fa"
fastq_EXT=".fastq"
